...
function setNativeProps(node, nativeProps, classList, style, previousStyleRef) {
  if (node != null && nativeProps) {
    var domProps = createDOMProps(null, _objectSpread({}, nativeProps, {
...
export default function usePlatformMethods(hostRef, classList, style) {
  ...
  useImperativeHandle(hostRef, function () {
    ...
    hostNode.measureLayout = function (relativeToNode, success, failure) {
      return UIManager.measureLayout(hostNode, relativeToNode, success, failure);
    };

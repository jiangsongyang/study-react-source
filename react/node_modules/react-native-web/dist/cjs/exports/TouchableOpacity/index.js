...
function getStyleOpacityWithDefault(style) {
  var flatStyle = _StyleSheet.default.flatten(style);

  var opacityValue = flatStyle != null ? flatStyle.opacity : null;
...
function TouchableOpacity(props, forwardedRef) {
  ...
  var styleOpacity = getStyleOpacityWithDefault(style);

  var _useState = (0, React.useState)('0s'),
      duration = _useState[0],
      setDuration = _useState[1];

  var _useState2 = (0, React.useState)(styleOpacity),
  ...
  var opacityActive = (0, React.useCallback)(function (duration) {
    setOpacityTo(activeOpacity !== null && activeOpacity !== void 0 ? activeOpacity : 0.2, duration);
  }, [activeOpacity, setOpacityTo]);
  var opacityInactive = (0, React.useCallback)(function (duration) {
  ...
  }, [delayLongPress, delayPressIn, delayPressOut, disabled, onLongPress, onPress, onPressIn, onPressOut, opacityActive, opacityInactive, rejectResponderTermination]);
  ...
  return React.createElement(_View.default, _extends({}, rest, pressEventHandlers, {
    ...
    ref: setRef,
    style: [styles.root, !disabled && styles.actionable, style, {
      opacity: opacity,

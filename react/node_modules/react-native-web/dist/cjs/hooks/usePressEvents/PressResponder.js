...
function () {
  ...
  _proto._receiveSignal = function _receiveSignal(signal, event) {
    ...
    (0, _invariant.default)(nextState != null && nextState !== ERROR, 'PressResponder: Invalid signal `%s` for state `%s` on responder: %s', signal, prevState, this._responderID);
